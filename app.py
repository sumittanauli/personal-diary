...
password = 'sparta'
cxn_str = f'mongodb+srv://test:{password}@cluster0.atoqiqv.mongodb.net/?retryWrites=true&w=majority'
...
def ditambah():
    bil1 = int(request.form['num1'])
    bil2 = int(request.form['num2'])
    hasil = bil1+bil2
    return jsonify({'hasil_tambah' : hasil})
...
def dikurang():
    ...
    bil2 = int(request.form['num2'])
    hasil = bil1-bil2
    return jsonify({'hasil_kurang' : hasil})
...
def dikali():
    ...
    bil2 = int(request.form['num2'])
    hasil = bil1*bil2
    return jsonify({'hasil_kali' : hasil})
...
def dibagi():
    ...
    bil2 = int(request.form['num2'])
    hasil = bil1/bil2
    return jsonify({'hasil_bagi' : hasil}) 
